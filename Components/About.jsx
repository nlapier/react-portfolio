...
import css from "../Components/About.css";
...
class About extends Component {
	...
	render() {
		...
		return (
			<div>
				<h1 className="text-center col-xs-12" style={styles.title}>About Me</h1>
				...
				<img src={"/assets/images/Headshot2.jpg"} alt="Nathaniel LaPier" className="img-circle img-responsive col-md-3" />
